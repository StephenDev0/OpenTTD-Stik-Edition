...
enum class Commands : uint8_t {
	...
	PlacePlayerHouse, ///< CITYSIM: place a house as a company (city building)
	FileIpo, ///< CITYSIM: take the company public
	IssueDividend, ///< CITYSIM: pay a dividend to public shareholders
	SetDividendPolicy, ///< CITYSIM: set the automatic dividend policy
	BuyVentureStake, ///< CITYSIM: buy a stake in a startup
	SellVentureStake, ///< CITYSIM: sell a stake in a startup
