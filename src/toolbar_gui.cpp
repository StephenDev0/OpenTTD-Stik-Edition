...
enum class TownMenuEntries {
	...
	ShowCityBuilding, ///< CITYSIM: open the city building toolbar.
};
...
static CallBackFunction ToolbarTownClick(Window *w)
{
	...
	list.push_back(MakeDropDownListStringItem(STR_TOWN_MENU_CITY_BUILDING, TownMenuEntries::ShowCityBuilding)); /* CITYSIM */
...
static CallBackFunction MenuClickTown(int index)
{
	switch (TownMenuEntries(index)) {
		...
		case TownMenuEntries::ShowPlaceHouses: // Setting could be changed when the dropdown was open
			...
			break;
		case TownMenuEntries::ShowCityBuilding: ShowCityBuildToolbar(); break; /* CITYSIM */
	}
	return CallBackFunction::None;
}
